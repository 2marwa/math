...
class MathGame:
    ...
    def medium_question(self):
        ...
        self.current_question += 1
        n1 = random.randint(1, 20)  # Generate the first random number
        n2 = random.randint(1, 20)  # Generate the second random number
        self.correct_answer = n1 + n2  # Calculate the correct answer
    ...
    def hard_question(self):
        ...
        self.current_question += 1
        n1 = random.randint(1, 50)  # Generate the first random number
        n2 = random.randint(1, 50)  # Generate the second random number
        self.correct_answer = n1 + n2  # Calculate the correct answer
